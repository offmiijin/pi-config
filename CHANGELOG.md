...
- `web_fetch` passa a salvar páginas HTML como Markdown (`.md`) via novo módulo `html-to-markdown` (contrato + pipeline; conversão estruturada de links/tags nas fases seguintes), em vez de `.txt`
